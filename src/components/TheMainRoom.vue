...
<template>
  ...
  <a-entity
    id="entity-bg-music"
    sound="src: #background-music; volume: 0.3; loop: true; positional: false"
  ></a-entity>

  <!-- WinMusic -->
  <a-entity
    id="entity-win-music"
    sound="src: #win-music; volume: 0.1; loop: true; positional: false"
  ></a-entity>
